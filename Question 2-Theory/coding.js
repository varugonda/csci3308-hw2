function display2_1() {
  var myanswer  = "My answer goes here: (1) undefined because dragonball is not an element of saiyan(2)true because a double equal checks their basic condition and they are both boolean false (3) false because technically null and undefined are different types and tripe equals does not call a type conversion" // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: This code throws an error since x has never been declared. Once \"use strict\" is removed it will run without issue." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: Under div_1134 the style display is 'none' so it doesn't show up" // TODO 2.5: Fill in Answer here
